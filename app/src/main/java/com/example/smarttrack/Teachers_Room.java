...
public class Teachers_Room extends AppCompatActivity {
    ...
    private FirebaseAuth auth;  // Declare as a class variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            Log.d("LOGIN", "User is already logged in, redirecting to appropriate dashboard.");
            auth.signOut();  // Ensure user is signed out if returning to Login
        }
        ...
        // Check if a user is already logged in and log out if necessary
        ...
        manualLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String url = "https://www.figma.com/proto/Wu25UR6CZCS31h2bFZXl6Y/SmartTrack_Manual?node-id=107-104&t=Wz4XyUExxNiLKJUy-1&scaling=min-zoom&content-scaling=fixed&page-id=107%3A103";
        ...
        logoutButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Teachers_Room.this, Login.class);
...
// Sort button listener
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    if (queryDocumentSnapshots != null && !queryDocumentSnapshots.isEmpty()) {
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            // Store room details in a nested map
                        ...
                        findViewById(R.id.noRoomsTextView).setVisibility(View.VISIBLE);
                    }
                })
    ...
    private void displayRooms(Map<String, Map<String, String>> roomDetails) {
        ...
        boolean hasRooms = !roomDetails.isEmpty();

        TextView noRoomsTextView = findViewById(R.id.noRoomsTextView);
        noRoomsTextView.setVisibility(View.GONE); // Initially hide the message
        ...
        if (hasRooms) {
            ...
            for (Map.Entry<String, Map<String, String>> entry : roomDetails.entrySet()) {
                ...
                // Skip rooms that are not active (endDate already passed)
                if (!isActive) {
                    continue;
                }
                ...
                // Create CardView for each active room
                ...
                // Status Indicator (Green for active)
        ...
        if (!hasRooms || !hasActiveRooms) {
            // Display "No Rooms Found" message if no rooms are available or if all are expired
            noRoomsTextView.setVisibility(View.VISIBLE);
            noRoomsTextView.setText("No Rooms Available");
    ...
    private void sortRooms() {
        ...
        displayRooms(allRooms); // Force UI refresh
    }
